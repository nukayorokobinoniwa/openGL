...
// bool isJumping = false; // ジャンプ機能を削除
// float jumpSpeed = 0.3f; // ジャンプ機能を削除
// float verticalVelocity = 0.0f; // ジャンプ機能を削除
// const float gravity = 0.015f; // ジャンプ機能を削除
...
void keyboard(unsigned char key, int x, int y) {
    ...
    switch (key) {
        // case ' ': if (!isJumping) { isJumping = true; verticalVelocity = jumpSpeed; } break; // ジャンプ機能を削除
